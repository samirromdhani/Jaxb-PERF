...
//import com.github.jaxblib.commons.jaxbV2.address.PurchaseOrderType;
 ...
 * events. Once it hits a SCL element, it creates a new
...
public class Splitter extends XMLFilterImpl {
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes atts)
        ...
        if( namespaceURI.equals("") && localName.equals("SCL") ) {
    ...
    public void endElement(String namespaceURI, String localName, String qName) throws SAXException {
        ...
        if( depth!=0 ) {
            ...
            if( depth==0 ) {
                ...
                try {
                    JAXBElement<SCL> result =
                            (JAXBElement<SCL>)unmarshallerHandler.getResult();
    ...
    /*
    public void process( SCLType order ) {
        System.out.println(">>>>>>>> this order will be shipped to ");
    }*/

        public void process( SCL order ) {
        System.out.println("this scl will be shipped to "
                + order.getIED().size() );
    }
